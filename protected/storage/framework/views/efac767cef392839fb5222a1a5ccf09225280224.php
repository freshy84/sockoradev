			...
			<div class="col-md-12">
				<div class="portlet">
					<div class="portlet-title">
						...
						<div class="actions">
							<a class="btn blue-madison btn-circle" href="<?php echo e(ADMIN_URL); ?>reseller/add">
								<i class="fa fa-plus"></i>
								<span class="hidden-480">Add Reseller</span>
							</a>
						</div>
					</div>
				</div>                     
                <div class="portlet-body">
                    <div class="table-container ">
						...
						<div class="table-actions-wrapper">
							...
							ADMIN_URL.'reseller/bulk-action'; ?>"/>
						</div>
						<table class="table table-striped table-hover table-bordered" id="datatable_ajax">
							<thead>                
								...
								<tr role="row" class="filter">
									...
									<td rowspan="1" colspan="1">
										<input type="text" name="v_name" class="form-control form-filter input-sm"/>
									</td>
									<td rowspan="1" colspan="1">
...
<script>
    $(document).ready(function(){
        var url = ADMIN_URL+'reseller/list-ajax';
        TableAjax.init(url);
	});
</script>
