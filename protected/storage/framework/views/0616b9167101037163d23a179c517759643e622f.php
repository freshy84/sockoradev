...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo e(ASSET_URL); ?>css/themes/darkblue.css<?php echo e(CSS_VERSION); ?>" rel="stylesheet" type="text/css" id="style_color"/>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content page-style-square">
        ...
        <div class="page-container">
            <!-- BEGIN SIDEBAR -->
            <?php echo $__env->make('elements.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <!-- END SIDEBAR -->
