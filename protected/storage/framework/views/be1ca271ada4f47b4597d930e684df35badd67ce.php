			...
			<div class="col-md-12">
				<div class="portlet">
					<div class="portlet-title">
						...
						<?php if(auth()->guard('admin')->user()->e_user_type == 'Admin'): ?>
							<div class="actions">
								<a class="btn blue-madison btn-circle" href="<?php echo e(SITE_URL); ?>users/add">
                ...
                <div class="portlet-body">
                    <div class="table-container ">
						...
						<div class="table-actions-wrapper">
							...
							<input type="hidden"  class="table-group-action-url" value="<?php echo e(SITE_URL); ?>users/bulk-action"/>
						</div>
