    ...
    <div class="page-content my-profile" style="min-height:1100px">
        <div class="portlet box blue-madison">
    		<div class="portlet-title">
    			<div class="caption">
    				<i class="icon-user"></i><?php echo e($title); ?>

    			</div>
    		</div>
            <div class="portlet-body form">
                <div class="form-body">
                    <form role="form"  action="<?php echo e(action('Admin\AuthenticateController@my_profile')); ?>" name="update_profile" class="form-horizontal" id="update_profile" method="post" onsubmit="return false;">
                        <?php echo csrf_field(); ?>                       
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4"><input type="text" value="<?php echo e($records['v_firstname']); ?>" name="v_firstname" placeholder="Your first name" class="form-control input-icon required aplha" id="v_firstname"/></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Last Name<span class="redLabel">*</span></label>
                            <div class="col-md-4"><input type="text" value="<?php echo e($records['v_lastname']); ?>" name="v_lastname" placeholder="Your last name" class="form-control input-icon required alpha" id="v_lastname"/></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Email<span class="redLabel">*</span></label>
                            <div class="col-md-4"><input type="text" name="v_email" placeholder="Your email id" value="<?php echo e($records['v_email']); ?>" class="form-control input-icon required email"/>
                            ...
                            <div class="input-file-box col-md-8">
                                <div class="fileinput" data-provides="fileinput">
                                    ...
                                    if (File::exists(USER_PROFILE_IMAGE_PATH . $records['v_profile_image']) && $records['v_profile_image'] != '') {
                                        ...
                                        echo SITE_URL . USER_PROFILE_IMAGE_PATH . 'default-image.png';
                                    }
                                    ?>" class="img-responsive default_img_size" name="profileimg"  alt="" id="profile_pic" />

                                    <img  width="220px" src="<?php echo e(SITE_URL.USER_PROFILE_IMAGE_PATH.'default-image.png'); ?>" class="img-responsive default_img_size" id="defailt_profile_pic" style="display: none;"/>
                                </div>
                                ...
                                <div style="margin-top:20px">
                                    ...
                                    <button class="btn btn-default" type="button" id="remove_image" style="display: <?php echo e(File::exists(USER_PROFILE_IMAGE_PATH.$records['v_profile_image']) && $records['v_profile_image'] !='' ? 'inline-block' : 'none'); ?>;">Remove</button> 
                                </div>
                        ...
                        <div class="margiv-top-10 form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="<?php echo e(ADMIN_URL); ?>dashboard" class="btn default">Cancel </a>
                                </div>
                            </div>
                        </div>
                    </form>
