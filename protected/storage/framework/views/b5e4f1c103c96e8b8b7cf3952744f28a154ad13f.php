...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
        ...
        <li class="<?= $curr_controller == "Authenticate" && $curr_action == "dashboard" ? 'active' : null ?>">
            <a href="<?php echo e(action('AuthenticateController@dashboard')); ?>" data-container="body" data-placement="bottom" data-html="true" >
                <i class="icon-home"></i>
        ...
        <li class="<?= $curr_controller == "Users" ? 'active' : null ?>">
            <a href="<?php echo e(action('UsersController@getIndex')); ?>" data-container="body" data-placement="bottom" data-html="true" >
        ...
        <li class="<?= $curr_controller == "Orders" ? 'active' : null ?>">
            <a href="<?php echo e(action('OrdersController@getIndex')); ?>" data-container="body" data-placement="bottom" data-html="true" >
                <i class="fa fa-users"></i>
        ...
        <li class="<?= $curr_controller == "Authenticate" && $curr_action == "my_profile" ? 'active' : null ?> setting">
            <a href="<?php echo e(action('AuthenticateController@my_profile')); ?>">
                <i class="icon-user"></i>
