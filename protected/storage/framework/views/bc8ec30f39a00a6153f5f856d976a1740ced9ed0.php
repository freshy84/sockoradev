...
<!-- END LOGO -->
<div class="content">
    <form action="<?php echo e(action('Admin\AuthenticateController@index')); ?>" id="login-form" name="loginFrm" class="login-form" method="POST">
    ...
    <form action="<?php echo e(action('Admin\AuthenticateController@forgot_password')); ?>" id="forget-form" name="forget-pass-form" class="forget-form" method="POST">
        <?php echo csrf_field(); ?>
