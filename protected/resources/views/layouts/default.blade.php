...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ ASSET_URL }}plugins/fullcalendar/fullcalendar.min.css{{CSS_VERSION}}" rel="stylesheet" type="text/css"/>
        <link rel="stylesheet" type="text/css" href="{{ ASSET_URL }}plugins/bootstrap-select/bootstrap-select.min.css{{CSS_VERSION}}"/>
        <link rel="stylesheet" type="text/css" href="{{ ASSET_URL }}plugins/select2/select2.css{{CSS_VERSION}}"/> 
        <link rel="stylesheet" type="text/css" href="{{ ASSET_URL }}plugins/jquery-multi-select/css/multi-select.css{{CSS_VERSION}}"/>
        ...
        <link href="{{ ASSET_URL }}plugins/fullcalendar/fullcalendar.min.css{{CSS_VERSION}}" rel="stylesheet"/>
        ...
        <script src="{{ ASSET_URL }}plugins/bootstrap-switch/js/bootstrap-switch.js{{JS_VERSION}}" type="text/javascript"></script>
        <script type="text/javascript" src="{{ ASSET_URL }}plugins/bootstrap-touchspin/bootstrap.touchspin.js{{JS_VERSION}}"></script>
        ...
        <script type="text/javascript" src="{{ ASSET_URL }}plugins/bootstrap-select/bootstrap-select.min.js{{JS_VERSION}}"></script>
        <script type="text/javascript" src="{{ ASSET_URL }}plugins/select2/select2.min.js"></script>
        <script src="{{ ASSET_URL }}plugins/jquery-multi-select/js/jquery.multi-select.js" type="text/javascript"></script>
        ...
        <script type="text/javascript" src="{{ ASSET_URL }}plugins/select2/select2.min.js{{JS_VERSION}}"></script>
        ...
        <script type="text/javascript" src="{{ ASSET_URL }}plugins/ckeditor/ckeditor.js{{JS_VERSION}}"></script>
        <script type="text/javascript" src="{{ ASSET_URL }}plugins/ckeditor/adapters/jquery.js{{JS_VERSION}}"></script>
