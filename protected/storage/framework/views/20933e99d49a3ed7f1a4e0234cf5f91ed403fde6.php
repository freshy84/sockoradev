    ...
    <div class="page-content my-profile" style="min-height:1100px">
        <div class="portlet box blue-madison">
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    <form role="form"  action="<?php echo e(action('AuthenticateController@my_profile')); ?>" name="update_profile" class="form-horizontal" id="update_profile" method="post" onsubmit="return false;">
                        <?php echo csrf_field(); ?>                       
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-file-box col-md-8">
                                <div class="fileinput" data-provides="fileinput">
                                    ...
                                    <img  width="220px" src="<?php echo e(SITE_URL.'assets/img/default-image.png'); ?>" class="img-responsive default_img_size" id="defailt_profile_pic" style="display: none;"/>
                                </div>
                        ...
                        <div class="margiv-top-10 form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="<?php echo e(SITE_URL); ?>dashboard" class="btn default">Cancel </a>
                                </div>
                            </div>
                        </div>
                    </form>
