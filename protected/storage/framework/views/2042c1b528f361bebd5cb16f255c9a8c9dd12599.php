    ...
    <div class="page-content" style="min-height:1100px">
        <div class="portlet box blue-madison">
            ...
            <div class="portlet-body form">
                <form role="form" method="post" class="form-horizontal" id="frmAdd" name="frmAdd" onsubmit="return false;" action="<?php echo e(action('Admin\ResellerController@anyAdd')); ?>">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control input-icon required alpha" name="v_name" placeholder="Name" id="v_name"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-2">
