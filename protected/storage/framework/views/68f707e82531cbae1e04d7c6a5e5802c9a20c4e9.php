...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        ...
        <div class="page-logo logo_dis">
            <span class="log_title">Fresh Setup</span>
        </div>
        <!-- END LOGO -->
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        ...
                        ?>"/>
                        <span class="username username-hide-mobile" id="name"><?php echo e(Auth::guard('admin')->user()->v_firstname); ?> <?php echo e(Auth::guard('admin')->user()->v_lastname); ?></span>
