    ...
    <div class="page-content" style="min-height:1100px">
        <div class="portlet box blue-madison">
            ...
            <div class="portlet-body form">
                <form role="form" method="post" class="form-horizontal" id="frmAdd" name="frmAdd" onsubmit="return false;" action="<?php echo e(action('UsersController@anyAdd')); ?>">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control input-icon" id="e_status" name="e_status">
                                                <option value="1" ><?php echo e(ACTIVE_STATUS); ?></option>
                                                <option value="0" ><?php echo e(INACTIVE_STATUS); ?></option>
                                            </select>
										</div>
									</div>
